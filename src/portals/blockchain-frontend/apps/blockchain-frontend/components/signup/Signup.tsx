...
export default function SignUp({ updateIsRegister }) {
  ...
  return (
    <form onSubmit={handleSignupFormSubmit}>
      <div className="mb-4">
        <label htmlFor="username" className="block font-medium text-gray-800">Email</label>
        <input
      ...
      <div className="mb-6">
        <label htmlFor="passwordConfirmation" className="block font-medium text-gray-800">Confirm Password</label>
        <input
      ...
      {!isAvailable && (
        <p className="text-red-500 text-sm mb-4">Email address not available.</p>
      )}
      {!isMatch && (
        <p className="text-red-500 text-sm mb-4">Password and password confirmation do not match. Please try again.</p>
      )}
      <div>
        <button
          type="submit"
